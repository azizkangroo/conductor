...
public class OracleQueueDAOTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OracleQueueDAOTest.class);

    private OracleQueueDAO queueDAO;
    ...
    public void pollMessagesTest() {
        ...
        try (Connection c = dataSource.getConnection()) {
            String UNPOPPED =
                    "SELECT COUNT(*) FROM queue_message WHERE queue_name = ? AND popped = 'N'";
